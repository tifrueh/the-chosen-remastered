...
namespace crsrc {
    ...
    const std::string throne_entrance_txt = "You are now standing in a big, decorated room. There is a sign on the north wall, upon which is written in big, golden letters: \"Entrance to the Throne Room of His Majesty\". Light comes from three torches, one on each wall.";
