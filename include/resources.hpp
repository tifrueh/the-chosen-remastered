...
namespace crsrc {
    ...
    const std::array<std::string, 15> welcome_message_txt = {
        ...
        "I suppose it is not so, for you would not be here if it were. So let me tell about your Quest:",
        "You must find the legendary Swords of Dusk and Dawn in order to kill the Demon King",
        "and thus finally end his cruel reign and free the land from the clutches of his demons. Fare thee well!",
        "",
